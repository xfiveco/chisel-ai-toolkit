...
| ------------------------------------------------------------------------------------------------------- | ----------------------------------------- | --------------------------------------------------------------------- |
| Global block margins (all blocks)                                                                       | `src/styles/blocks/_core.scss`            | `.c-block--{name}` bottom margins for text and media/container blocks; the wide/full rail rules and the `$rail-bleed` list ([blocks.md "Wide and full width"](.claude/chisel/reference/blocks.md#wide-and-full-width)) |
...
| `core/group`                                                                                            | `src/styles/blocks/_core-group.scss`      | `:where(.has-background)` default `padding: get-padding('big')` — a seeded padding preset overrides it |
...
| `core/media-text`                                                                                       | `src/styles/blocks/_core-media-text.scss` | Media+text layout; at full width the media bleeds, the text stops at `--rail-edge` |
| `core/table` / `core/code` / `core/preformatted`                                                        | `src/styles/utilities/_table.scss`, `_core.scss` | Scroll inside the block on mobile (`u-table-responsive`, `overflow-x: auto`) |
